...
<head>
<meta charset="UTF-8">
<title>${employee.name} 의 정보 페이지</title>
...
<form method="post" name="frm" action="employee">
	...
	<input type="button" value="수정"
		onclick="location.href='employee?command=employees_update_form&id=${employee.id }'">
	<input type="button" value="삭제"
		onclick="location.href='employee?command=employees_delete&id=${employee.id}'">
